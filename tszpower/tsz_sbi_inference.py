...
from tsz_sims import simulator as tsz_simulator
...
def infer_npe(theta, x, prior = None, show_train_summary=True, num_sims = 2000, stop_after_epochs = 200, learning_rate = 5e-5,
    ...
    inference.append_simulations(theta, x).train(show_train_summary=show_train_summary,stop_after_epochs=stop_after_epochs, learning_rate=learning_rate)
...
def infer_nle_single_round(theta, x, prior = None, show_train_summary=True, num_sims = 2000, num_rounds = 1, stop_after_epochs = 200, learning_rate = 5e-5,
              num_posterior_samples = 100000, true_data_path = "/home/lx256/tsz_project/tszpower/data/data_ps-ell-y2-erry2_total-planck-collab-15.txt"):
